...
public class Stream_03_Test {
	...
	public void test_max() throws Exception {
		...
		Optional<Order> result = orders.stream().collect(Collectors.maxBy(Comparator.comparingDouble(order->order.getPizzas().stream().mapToDouble(Pizza::getPrice).sum())));
	...
	public void test_min() throws Exception {
		...
		Optional<Order> result = orders.stream().collect(Collectors.minBy(Comparator.comparingDouble(order->order.getPizzas().stream().mapToDouble(Pizza::getPrice).sum())));;
